...
interface PropsType extends React.Props<any> {
  width?: string;
  height?: string;
  color?: string;
  className?: string;
  ...
  return (
    ...
    >
      <g>
        ...
        />
        <polygon fill={color} points="320.8,78.4 320.8,78.4 320.8,78.4 	" />
        <circle fill={color} cx="420.9" cy="296.5" r="45.7" />
        <polygon fill={color} points="520.5,78.1 520.5,78.1 520.5,78.1 	" />
      </g>
    </svg>
  );
};
