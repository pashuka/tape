 ...
 *
 * The SseStream#writeMessage(message) method is a type-safe alias for
 * SseStream#write(message).
 *
 * Usage
 * In a (`req`, `res`) handler for a request event, Koa #get route or similar:
 *
