...
exports.NotFound = class Unauthorized extends ExtendableError {
  constructor(message) {
    super("Not Found");
    this.body = {
      errors: [
...
// TODO: Add '406 Not Acceptable' like: ctx.throw(406, 'unsupported content-type')
